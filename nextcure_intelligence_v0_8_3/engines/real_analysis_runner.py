...
def run_real_analysis() -> AnalysisResults:
    ...
    insights = insights + [market_regime.combined_read, window_score.interpretation] + technical_lines + catalyst_insights[:3] + capital_flow_insights[:2] + event_reaction_insights[:1]
