"""NextCure Intelligence System - Iteration 8.3 UI/navigation polish build.
...
from ui.charts import capital_flow_chart, catalyst_priority_chart, channel_momentum_chart, peer_bar_chart, relative_performance_chart, technical_stock_chart, technical_setup_chart
...
if st.session_state.analysis_started and st.session_state.results is not None:
    ...
    if active_page == "Technical + Catalyst":
        ...
        st.markdown(
            """
            <div class="muted" style="margin-bottom: .85rem;">
                v0.8 combines real technical analysis with catalyst timing. The goal is not to say buy or sell;
    ...
    st.markdown(
        ...
        <div class="card">
            ...
            <div class="muted">
                Iteration 8 now combines the premium START workflow with real market data, explicit 30D / 60D / Quarterly 90D return windows,
                peer-channel classification, catalyst meaning, capital-flow intelligence, market window scoring, scenario outlook, advanced technical positioning, catalyst timing comparison, and a CEO-readable strategy engine. The interaction remains one-button and backend-driven.
            </div>
        </div>
        """,
        unsafe_allow_html=True,
